...
func detectDimensionsByService2(service *string, resource *string, clientCloudwatch cloudwatchInterface) (dimensions []*cloudwatch.Dimension) {
	switch *service {
	case "ec":
		dimensions = buildBaseDimension(*resource, "CacheClusterId", "cluster:")
	case "rdb":
		dimensions = buildBaseDimension(*resource, "DBInstanceIdentifier", "db:")
	default:
